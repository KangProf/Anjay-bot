...
async function chatGpt(query) {
	return new Promise(async (resolve, reject) => {
		try {
			const anu = await axios.post('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=YOUR_API_KEY', JSON.stringify({
